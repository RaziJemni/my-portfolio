...
export default function Home() {
    ...
    const projects = [
        ...
        {
            title: "VESOS Ambassadeurs ISIMS",
            technologies: "React, Tailwind CSS",
            repoUrl: "https://www.vesos-ambassadeurs-isims.tn",
            target: "_blank",
            imgUrl: "vesos-website.png",
        },
    ];
                    ...
                    <div className="flex flex-col md:flex-row items-center">
                        <div className="md:w-1/2 space-y-6">
                            <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                                Hey I'm{" "}
                                <span className="text-primary">Razi!</span>
                            </h1>
                ...
                <div className="bg-[#1a1a1a]/80 rounded-3xl p-6 md:p-12 shadow-lg shadow-secondary/10 backdrop-blur-md">
                    ...
                    <div className="space-y-6 text-base md:text-lg">
                        <p className="leading-relaxed">
                            I'm a Computer Science student passionate about
                            exploring different areas of tech — from web and
                            mobile development to cybersecurity and algorithms.
                            I enjoy learning new languages, building real
                            projects, and growing my skills across the stack.
                        </p>
                        <p className="leading-relaxed">
                            ...
                            , and more. Always learning, always building — and
                        ...
                        <div className="pt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            {skills.map((skill, index) => (
                                ...
                                >
                                    <h3
                                        className={`text-xl font-semibold mb-2 ${index % 2 === 0 ? "text-primary" : "text-secondary"}`}
                                    >
                                        {skill.title}
                                    </h3>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {projects.map((project, index) => (
                            ...
                            >
                                {/* Project Card */}
                                <div
                                    className={`bg-[#2a2a2a] rounded-xl overflow-hidden aspect-video relative shadow-md hover:shadow-lg ${index % 2 === 0 ? "hover:shadow-primary/20" : "hover:shadow-secondary/20"} transition-all duration-300 transform group-hover:-translate-y-2`}
                                >
                                    <img
                                        src={project.imgUrl}
                                        alt={project.title}
                                    ...
                                    />
                                    <div
                                        className={`absolute inset-0 ${index % 2 === 0 ? "bg-gradient-to-br from-primary/10 to-secondary/10" : "bg-gradient-to-br from-secondary/10 to-primary/10"} group-hover:opacity-70 transition-opacity duration-300`}
                                    ></div>
                                </div>
                                <div className="mt-4">
                                    <h3
                                        className={`text-xl font-semibold ${index % 2 === 0 ? "group-hover:text-primary" : "group-hover:text-secondary"} transition-colors duration-300`}
                                    >
                                        {project.title}
                                    </h3>
            ...
            <footer className="container mx-auto px-4 py-8 text-center">
                <div className="py-6 border-t border-gray-800">
                    <p className="text-gray-400">
                        © {new Date().getFullYear()} Razi Jemni. All rights
                        reserved.
                    </p>
